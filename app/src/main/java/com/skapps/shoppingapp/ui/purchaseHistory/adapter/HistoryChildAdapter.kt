...
class HistoryChildAdapter(private val productList: List<ProductResponce>):RecyclerView.Adapter<HistoryChildAdapter.ChildViewHolder>() {
    class ChildViewHolder(private val binding:RowChildHistoryPurchaseBinding):RecyclerView.ViewHolder(binding.root){
