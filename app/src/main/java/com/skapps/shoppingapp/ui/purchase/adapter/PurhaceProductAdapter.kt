...
import com.skapps.shoppingapp.databinding.RowPurchaseProductBinding
...
class PurhaceProductAdapter(val productsList: List<Product>) :
    ...
    class PurchaseViewHolder(val binding: RowPurchaseProductBinding) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PurchaseViewHolder {
        val binding=RowPurchaseProductBinding.inflate(LayoutInflater.from(parent.context),parent,false)
